...
!function (NioApp, $) {
  ...
  var orderOverview = {
    ...
    dataUnit: '%',
    datasets: [{
      label: "Oilbased-Colours",
      color: "#1d60b8",
      data: [40, 42, 87, 39, 75, 65, 87,63 , 64, 79]
    }, {
      label: "Acyalic-Colours",
      color: "#0bbf5c",
      data: [58, 59, 75, 65, 68, 61, 62, 67, 78, 76]
    }, {
      label: "Water-Based",
      color: "#8c066d",
      data: [52, 58, 57, 61, 60, 53, 58, 47, 64, 50]
    }]
  };
  ...
  var userActivity = {
    ...
    stacked: true,
    datasets: [{
      label: "Succesfully Installed Nodes",
      color: "#0b9e74",
      data: [110, 80, 125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90]
    }, {
      label: "Nodes in Stock  ",
      color: NioApp.hexRGB("#78fad5", .2),
  ...
  var coinOverview = {
    labels: ["Total Nodes", "Working Nodes", "Nodes in Stock","Deffective Nodes"],
    stacked: true, 
    datasets: [{
      label: "Node",
      color: ["#f98c45", "#6baafe", "#8feac5","#1f1d01"],
      data: [1740, 2500, 1820, 100]
    }, {
      label: "Nodes",
      color: [NioApp.hexRGB('#f98c45', .2), NioApp.hexRGB('#6baafe', .4), NioApp.hexRGB('#8feac5', .4), NioApp.hexRGB('#1f1d01', .4)],
